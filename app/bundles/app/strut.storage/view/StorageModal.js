define(['backbone', 'tantaman/web/widgets/FileBrowser', 'tantaman/web/widgets/FileBrowserElectron', 'css!styles/storage/storageModal.css'],
	function(Backbone, FileBrowser, FileBrowserElectron)
	{
		return Backbone.View.extend(
		{
			...
			initialize: function()
			{
				...
				{
					this.fileBrowser = new FileBrowserElectron(this.storageInterface, this.editorModel);
				}
				else
				{
			...
			show: function(actionHandler, title)
			{
				...
				this.title(title);
				this.$el.modal('show');
				this.fileBrowser.action = this.actionHandler.name;
