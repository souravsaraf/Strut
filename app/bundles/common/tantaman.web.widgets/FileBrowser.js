define(['backbone', 'css!styles/widgets/fileBrowser.css'],
	function(Backbone, empty)
	{
		return Backbone.View.extend(
		{
			...
			{
				var self = this;
				this.storageInterface.listPresentations(window.electronConfig.storage.presentationFolder, function(list, err)
				{
					if (err)
					{
					...
					{
						self.$fileName.val(window.electronConfig.storage.presentationFolder);
					}
				});
			},
